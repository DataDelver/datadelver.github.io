...
![Banner](../assets/images/banners/delve3.webp)
...
1. Create a file called `01-custom-message`
1. Paste any commands you like to be run in this file and save it.
    ```
    #!/usr/bin/env bash

    fortune | cowsay -f tux
    ```
1. Make the file executable `$ sudo chmod +x 01-custom-message`
